...
# define TOOLS_PP_ARRAY_SORT_D(A)   TOOLS_PP_AS_RES(BOOST_PP_CAT(BOOST_PP_WHILE_, D)(TOOLS_PP_AS_PRED, TOOLS_PP_AS_OP,   (A, 0, (0, ()))))
# define TOOLS_PP_ARRAY_SORT_U_D(A) TOOLS_PP_AS_RES(BOOST_PP_CAT(BOOST_PP_WHILE_, D)(TOOLS_PP_AS_PRED, TOOLS_PP_AS_OP_U, (A, 0, (0, ()))))
